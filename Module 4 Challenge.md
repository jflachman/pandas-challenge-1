---
created: 2024-02-23T13:07:21 (UTC -07:00)
tags: []
source: https://bootcampspot.instructure.com/courses/5432/assignments/73213?module_item_id=1200277
author: 
---
...
[Module 4 Challenge files Links to an external site.](https://static.bc-edx.com/ai/ail-v-1-0/m4/lms/starter/Starter_Code.zip)
...
-   Create a column that calculates the subtotal for each line using the unit\_price and the qty.
...
-   Use the Pandas DataFrame [documentation Links to an external site.](https://pandas.pydata.org/docs/reference/frame.html) to find helpful functions. Feel free to use functions that you didn’t learn in class if you find they make the work easier!
...
-   Create a column that calculates the subtotal for each line using the unit\_price and the qty. (6 points)
